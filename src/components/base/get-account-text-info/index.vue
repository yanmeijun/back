...
<script>
import { findByAccountNameOrUniqueCode } from '@/api/new-media/data-review';
    ...
    const onRemoteMethod = async query => {
      ...
      state.timer = setTimeout(async () => {
        ...
        state.searchList = data.map(ele => {
          ...
          const selected = state.selectVal == ele.value;
          return {
            selected,
            label: ele,
            value: ele,

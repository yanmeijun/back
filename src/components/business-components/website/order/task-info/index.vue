<template>
  <div class="order-base-info">
    <h3 class="flex algin-center title">
      ...
      ></i>
      任务名称/任务号：{{ info.taskName }}/{{ info.taskCode }}
    </h3>
    <div class="info">
      <el-row :gutter="10">
        ...
        <el-col :xs="24" :sm="24" :md="14" :lg="15" :xl="18">
          <div class="flex align-center">
            ...
            <span class="value">{{ info.deliveryUsernameMeaning }}</span>
          </div>
        </el-col>
        <el-col :xs="24" :sm="24" :md="10" :lg="9" :xl="6">
          <div class="flex align-center">
    ...
    <div class="flex right">
      ...
      <div class="block">
        ...
        <el-dropdown placement="bottom">
          <p class="type">
            <span class="num">
              {{ completeData.completionCount || 0 }}
            </span>
            /{{ completeData.taskDetailTotal || 0 }}
          </p>
          <el-dropdown-menu class="result-tip" slot="dropdown">
            <el-dropdown-item>
              <p class="line-item-title">检查结果</p>
            </el-dropdown-item>
            <el-dropdown-item>
              <p class="line-item">合格/不合格</p>
              <p class="line-item-type">
                {{ completeData.qualifiedCount || 0 }} /
                {{ completeData.unQualifiedCount || 0 }}
              </p>
            </el-dropdown-item>
          </el-dropdown-menu>
        </el-dropdown>
...
<script>
import { getCompleteByTaskId } from '@/api/website/order';
...
export default {
  ...
  methods: {
    async getDetail() {
      ...
      let { data = {} } = await getCompleteByTaskId(id);

      ...
      <el-row :gutter="10">
        <el-col :xs="24" :sm="24" :md="10" :lg="9" :xl="6">
          <div class="flex align-center">
            ...
            <el-dropdown placement="bottom" v-if="info.serviceName">
          ...
          <div class="flex align-center">
            <el-dropdown placement="bottom">
              <span class="el-dropdown-link drop-menu left-label">
                数据权限<i class="el-icon-arrow-down el-icon--right"></i>
              </span>
              <el-dropdown-menu class="info-tip" slot="dropdown">
                <el-dropdown-item>
                  <div class="flex line-item">
            ...
            <span class="label left-label"
              >交付<i class="font-color">{{ info.deliveryTimes || 0 }}</i
              >次</span
            >
            <span class="label"
              >共<i class="font-color">{{ info.accountNum || 0 }}</i
              >个新媒体账号</span
            >
          </div>
        </el-col>

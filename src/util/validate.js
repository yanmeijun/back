...
export const pattern = {
  ...
  lowerCase: /^[a-z]+$/, // 小写字母
  upperCase: /^[A-Z]+$/, // 大写字母
  password: /^[a-zA-Z0-9]{6,16}$/ // 6-16位字母或数字 /^(?![^a-zA-Z]+$)(?!\D+$)/, // 必须字母数字组合6-16位
};
/* eslint-enable */
...
export function validateURL(textval) {
  return pattern.uri.test(textval);
}

/* 小写字母 */
export function validateLowerCase(str) {
  return pattern.lowerCase.test(str);
}

/* 大写字母 */
export function validateUpperCase(str) {
  return pattern.upperCase.test(str);
}
